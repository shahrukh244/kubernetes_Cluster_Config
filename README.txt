...
# To set IP & HostName run this script
python3 kubernetes_Cluster_Config/service_Node_Config/service_Node-01/01-set_IP.py
# system will Reboot in 15 sec

# To install Ansible-CLI Run Python Script (install-Ansible.py)
python3 kubernetes_Cluster_Config/service_Node_Config/service_Node-01/02-install-Ansible.py
